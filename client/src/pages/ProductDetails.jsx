    ...
    return (
        <div className='min-h-screen flex flex-col md:flex-row p-2 justify-center items-center gap-5 bg-blue-50 mt-21'>
            ...
            <div id="first-section" className=' max-w-[600px] overflow-hidden'>
                <img src={product.image} alt="product-img" className='h-90 md:h-120'/>
                <div id='buttons' className='flex flex-row items-center justify-center gap-2 p-2 font-bold '>
                    <button className='p-2 bg-amber-400 w-full rounded text-white h-10 ' onClick={addToCart}>ADD TO CART</button>
                    <button onClick={()=>handleBuyNow(product)} className='w-full bg-amber-500 rounded p-2 text-white h-10'>BUY NOW</button>
                </div>
            </div>
            <div id='details' className='flex flex-col gap-2 items-start justify-start p-1  '>
                ...
                <p className='text-gray-500 md:max-w-[450px]'>Bank Offer5% cashback on Flipkart Axis Bank Credit Card upto ₹4,000 per statement quarterT&C
